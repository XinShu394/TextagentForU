...
_FEATURE_INTRO = (
    ...
    "📝 【记事】发给我任何内容，我帮你整理归档\n"
    "✅ 【提醒】说「提醒我…」，到时间我会叫你\n"
    "📰 【日报】说「今日日报」，帮你回顾今天做了什么\n"
    "🔄 【复盘】说「打卡」，一起做每日小复盘\n"
    "🌤️ 【天气】说「天气」，我帮你看看今天穿什么合适\n"
    "📌 【随记】发「记 + 内容」，随时记下灵感想法\n"
    "🎨 【风格】说「日报简洁一点」，按你喜欢的方式来\n"
    "⚙️ 【设置】说「叫我XX」改昵称\n"
    "📊 【数据】说「导出数据」查看你的所有记录\n\n"
    "💬 当然，没事也可以找我聊聊天~ 我随时都在 ☺️"
)

# Markdown 版功能介绍（用于发送富文本消息）
_FEATURE_INTRO_MARKDOWN = """**🏠 我是你的私人小管家**
...
> 📰 **日报** — 说「今日日报」回顾今天做了什么
> 🔄 **复盘** — 说「打卡」一起做每日小复盘
> 🌤️ **天气** — 说「天气」帮你看今天穿什么合适
> 📌 **随记** — 发「记 + 内容」记录灵感，支持 #标签
> 🎨 **风格** — 说「日报简洁一点」按你喜欢的来
> ⚙️ **设置** — 说「叫我XX」改昵称
> 📊 **数据** — 说「导出数据」查看记录

<font color="info">💬 没事也可以找我聊聊天~ 我随时都在 ☺️</font>"""
